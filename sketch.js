...
function draw() {
  ...
  if (gameState === "start") {
    ...
    textSize(20);
    text(
      "Conserving water is important because it keeps water pure and clean while protecting the environment.Conserving water means using our water supply wisely.",
      5,
      400
    );
    text(
      "Let's play a game to see how much can we take care of our resources. Press space to play.",
      300,
      450
    );
    earth.visible = false;
